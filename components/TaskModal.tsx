      ...
      <div className="bg-white dark:bg-gray-900 w-full max-w-2xl rounded-[32px] shadow-2xl relative animate-scale-up flex flex-col max-h-[90vh] my-auto">
        ...
        <div className="p-8 overflow-y-auto custom-scrollbar space-y-8 flex-1">
          ...
          <div className="space-y-3">
             <label className="text-xs font-black uppercase text-gray-300 dark:text-gray-600 tracking-widest ml-1">Estado Actual</label>
        ...
        <div className="p-6 border-t border-gray-100 dark:border-gray-800 flex justify-between gap-4 bg-gray-50/50 dark:bg-gray-800/50 rounded-b-[32px]">
           ...
           <div className="flex gap-3">
              <button 
                onClick={onClose}
                className="px-8 py-4 font-bold text-gray-400 dark:text-gray-500 hover:text-black dark:hover:text-white transition-colors"
                disabled={loading}
              >
                CANCELAR
              </button>
